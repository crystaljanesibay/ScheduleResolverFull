...
class AiScheduleService extends ChangeNotifier{
  ...
  Future<void> analyzeSchedule(List<TaskModel> tasks) async {
    ...
    try {
      ...
      List any scheduling conflicts or state there are more.
      2. ### Ranked tasks
      Rank which tasks need attention first based on urgency, importance, and energy, provide a brief reason for each.
      3. ### Recommended Schedule 
      Provide a revised daily timeline view adjusting the task times to resolve conflicts and balance that students workload, study time and rest.
      4. ### Explanation
